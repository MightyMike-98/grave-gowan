    ...
    return (
        <main className="min-h-screen px-4 py-10">
            ...
            <div className="mx-auto max-w-xl pb-20 space-y-10 mt-8">
                ...
                {/* ── GALLERY MANAGEMENT (Only visible in Edit Mode) ── */}
                {isEditing && (
                <section className="pt-12 space-y-5">
                    <div className="mb-8 h-px" style={{ backgroundColor: 'hsl(var(--border) / 0.4)' }} />
                ...
                {/* ── STORIES MANAGEMENT (Only visible in Edit Mode) ── */}
                {isEditing && (
                <section className="pt-12 space-y-5">
                    <div className="mb-8 h-px" style={{ backgroundColor: 'hsl(var(--border) / 0.4)' }} />
                    ...
                    <div className="space-y-4">
                        {stories.map(story => (
                            <div key={story.id} className="rounded-xl border p-5 shadow-sm space-y-4 bg-white" style={{ borderColor: 'hsl(var(--border) / 0.4)' }}>
                                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 rounded-xl border p-4 shadow-sm bg-card mt-5" style={{ borderColor: 'hsl(var(--border) / 0.4)' }}>
                        ...
                        <label className="relative inline-block h-5 w-9 cursor-pointer rounded-full bg-primary/80">
                            ...
                            />
                            <span
                                className={`absolute left-0.5 top-0.5 h-4 w-4 rounded-full bg-primary-foreground shadow-sm transition-transform ${moderationEnabled ? "translate-x-4" : ""}`}
                            />
                        </label>
                    </div>

                    {/* Highlights Explanation Box (moved inside Stories context) */}
                    <div className="rounded-xl border p-5 shadow-sm space-y-3 bg-white" style={{ borderColor: 'hsl(var(--border) / 0.4)' }}>
                        <div className="flex items-center gap-2.5">
